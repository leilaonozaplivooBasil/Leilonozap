...
// 🏭 Planos do Parceiro de Compra (ex: "Private Galpão") — arte preto/dourado
const IMG_PRIVATE = 'https://media.base44.com/images/public/68d536db3c26ff51f79c4137/e72de0a3d_generated_image.png';
...
function arteDoTipo(order) {
  ...
  const ehDigital = KINDS_DIGITAL.includes(order?.kind) || /ades[ãa]o|licen[çc]a|plano|assinatura|parceiro de compra|private|galp[ãa]o/i.test(titulo);
