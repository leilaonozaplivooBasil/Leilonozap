...
export default function OfertasRelampago({ products = [] }) {
  ...
  return (
    <div className="relative z-10 -mt-10 sm:-mt-16 rounded-2xl pt-4 pb-4 mb-8 overflow-hidden border border-white/15 shadow-2xl shadow-black/50 bg-white/[0.02] backdrop-blur-sm backdrop-saturate-150">
