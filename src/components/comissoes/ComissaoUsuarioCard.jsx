...
// que pé está o KYC dela e o que falta pra sacar. SÓ CONSULTA — o pagamento é
// pelo saque da plataforma (ver src/lib/comissaoSoConsulta.js). Os botões
// "Marcar pago" e o editor de chave PIX saíram de propósito: pagar por fora
// pagava em dobro, e o PIX do saque é sempre o CPF validado no KYC.
export default function ComissaoUsuarioCard({ grupo }) {
