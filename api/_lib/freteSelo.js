...
//   • é daquele leilão e daquele usuário — selo de um não serve no outro;
 ...
 * @param {{auctionId:string, userId:string, freteId:string, valor:number, cep:string, empresa?:string, servico?:string, prazo?:number}} dados
 * @returns {string|null}
 */
export function emitirSelo({ auctionId, userId, freteId, valor, cep, empresa, servico, prazo }) {
 ...
 */
export function conferirSelo(selo, { auctionId, userId } = {}) {
  try {
