...
export default function DescriptionWithAI({ value, onChange }) {
  ...
  // 🤖 AUTO-GENERATE DESCRIPTION QUANDO O TÍTULO MUDAR
  useEffect(() => {
    ...
    // Só auto-gera se:
    // 1. Há um título
    // 2. A descrição está vazia (nunca foi preenchida manualmente)
    if (title && !value?.trim()) {
      debounceTimerRef.current = setTimeout(() => {
        autoGenerateDescription(title);
      }, 1500); // 1.5s de debounce após parada de digitação
    }
