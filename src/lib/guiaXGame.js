...
export const AULAS_BRUTAS = [
  ...
  },
  {
    ...
    numeros: [
      ...
      { nome: 'Human Token do dia', pergunta: 'quanto vale o seu dia', explica: `É MvM do Dia + Aplicabilidade, no máximo ${br(TOKEN_MAX)}. É a moeda do SEU DIA, e ela tem faixas.`, faixas: true },
