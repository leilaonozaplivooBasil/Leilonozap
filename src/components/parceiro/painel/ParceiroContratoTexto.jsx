...
// 📜 Texto integral do Contrato de Parceria Comercial (leitura na tela).
// Extraído de InvestorDashboard.jsx sem UMA VÍRGULA de alteração no conteúdo
// jurídico — mover o texto para cá foi só organização de arquivo.
export default function ParceiroContratoTexto() {
  return (
