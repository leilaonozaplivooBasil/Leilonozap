// 📈 EVOLUIR DE NÍVEL — os níveis pagos da rede e o upgrade com PIX/cartão.
// 06/09/2026: virou componente porque o dono uniu "Carreira" e "Evoluir Nível"
// numa seção só da Top College (CarreiraSecao); a rota /Evoluir continua
// existindo pra link antigo e usa este mesmo componente em tela cheia.
...
export default function EvoluirNivel({ embutido = false }) {
  ...
  if (loading) return <div className={`${embutido ? 'py-10' : 'min-h-screen'} bg-gray-900 flex items-center justify-center text-gray-400`}><Loader2 className="w-6 h-6 animate-spin mr-2" /> Carregando…</div>;
