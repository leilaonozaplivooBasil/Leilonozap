...
🧘 OLHOS FECHADOS, DEITADO OU SENTADO NA CAMA, NO ESCURO — EM CASA — É A PRÓPRIA VISUALIZAÇÃO, NÃO É PROVA CONTRA (24/09/2026). O título da tarefa fala em "acordar", mas ESTE frame NÃO é a prova do despertar: o despertar já foi julgado à parte, num bloco anterior, com a régua dele. Aqui a pessoa está visualizando o sonho — e visualizar é de olhos fechados, quieta, muitas vezes ainda no quarto, antes de a luz acender. Então NÃO aplique a este frame o cruzamento "acordar × deitado/olhos fechados/na cama": ele NÃO reprova, NÃO vira dúvida, e "fora da cama" NÃO é exigência deste bloco. O que decide aqui é só o AMBIENTE (casa × carro/academia/escritório) e a PESSOA (ela × outra pessoa). Exemplo real: um homem de olhos fechados, deitado na cama, no escuro, enquadramento fechado no rosto — isso é "duvida" pelo cômodo não aparecer, no máximo; nunca "reprovada" por estar deitado.
