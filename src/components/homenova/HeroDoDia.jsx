...
export default function HeroDoDia({ leilao, arte = null, chamada = 'Leilão do dia', video = null }) {
  ...
  // 25/09/2026 — o "na loja R$ X" saiu do hero (e do carrossel), por ordem do dono.
