  ...
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: "15%", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 24px", zIndex: 10 }}>
        <div>
          <p style={{ color: "#000", fontSize: 13, fontWeight: 900, textTransform: "uppercase" }}>{displayBrand}</p>
          <p style={{ color: "rgba(0,0,0,0.5)", fontSize: 9, fontWeight: 700 }}>{displayBrandSub}</p>
        </div>
