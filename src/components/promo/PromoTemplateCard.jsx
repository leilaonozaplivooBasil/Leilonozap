...
export default function PromoTemplateCard({ product, templateKey, overrides = {}, layout = "square", design = "classic" }) {
  ...
  const WhatsAppBadge = ({ dark }) => whatsappNumber ? (
    <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 4 }}>
      ...
      <span style={{ color: dark ? "#1f2937" : "rgba(255,255,255,0.8)", fontSize: 12, fontWeight: 700 }}>{whatsappNumber}</span>
    </div>
  ) : null;
  ...
  const renderFlashTemplate = () => (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      {/* Footer */}
      <div style={{ position: "absolute", bottom: 14, left: 24, right: 24, zIndex: 10 }}>
        <WhatsAppBadge dark />
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: whatsappNumber ? 6 : 0 }}>
  ...
  const renderGridTemplate = () => {
    ...
    return (
      <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
        ...
        {/* Footer */}
        <div style={{ position: "absolute", bottom: 12, left: 24, right: 24, zIndex: 10 }}>
          <WhatsAppBadge />
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: whatsappNumber ? 6 : 0 }}>
            <img src={logoUrl} alt="Leilão NoZap" style={{ height: 56, width: "auto", objectFit: "contain" }} />
