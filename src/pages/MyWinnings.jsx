            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8 sm:mb-10">
                    ...
                    <div className="flex items-center gap-4 mb-3">
                        ...
                        <div>
                            {/* 🎯 Título em tinta sólida: o degradê branco→cinza sumia
                                quando a tela entra no tema claro do painel. */}
                            <h1 className="text-3xl sm:text-4xl font-black text-nz-tinta">
                                Meus Arremates
                            </h1>
