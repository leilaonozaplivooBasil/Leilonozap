...
export const CHAVES = [
  ...
  { chave: 'expedicoes', rotulo: 'Pedidos expedidos no prazo', habito: 6, unidade: 'no mês', fonte: 'habito' },
  { chave: 'inventarios', rotulo: 'Conferências de estoque', habito: 7, unidade: 'no mês', fonte: 'habito' },
  { chave: 'contratacoes', rotulo: 'Contratações feitas', habito: 6, unidade: 'no mês', fonte: 'habito' },
  { chave: 'lotes', rotulo: 'Lotes comprados', habito: 6, unidade: 'no mês', fonte: 'habito' },
  { chave: 'atendimentos', rotulo: 'Atendimentos feitos', habito: 4, unidade: 'no mês', fonte: 'habito' },
  { chave: 'relatorios', rotulo: 'Relatórios publicados', habito: 7, unidade: 'no mês', fonte: 'habito' },
...
const SUGESTOES_DO_PAINEL = {
  ...
  // as funções de mercado (sem documento): sugestões, o dono ajusta
  rh: [['contratacoes', 4], ['reunioes', 2 * DIAS_FIXO], ['treinamentos', 8]],
  produto: [['entregas_tecnicas', 8], ['reunioes', 12]],
  compras: [['lotes', 4], ['contatos', 60], ['reunioes', 12]],
  atendimento: [['atendimentos', 30 * DIAS_FIXO], ['treinamentos', 8], ['fechamentos', 40]],
  expansao: [['pontos_retirada', 1], ['licenciados', 5], ['reunioes', 20], ['contratos', 6]],
  juridico: [['contratos', 20], ['relatorios', 4]],
  dados: [['relatorios', DIAS_FIXO], ['reunioes', 8]],
  gerente_loja: [['faturamento', 1000000], ['atendimentos', 132 * DIAS_FIXO], ['treinamentos', 8]],
  conteudo: [['lives', 20], ['entradas', 30000], ['treinamentos', 8]],
};
