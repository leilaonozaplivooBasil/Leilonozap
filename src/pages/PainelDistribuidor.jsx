...
export default function PainelDistribuidor() {
  ...
  // ?tab= permite que o menu escrito, vindo de outra tela (Pedidos, Editar Loja),
  // volte pro painel já na seção certa.
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white md:flex">
      ...
      {/* MENU ESCRITO DO PAINEL — mesmo componente usado em Pedidos & Envio e
          Editar Loja Virtual, pra ele não sumir ao trocar de tela. */}
      <MenuPainelLateral
        user={user}
        activeTab={tab}
        onTab={(id) => onMenu(MENU.find((m) => m.id === id) || { id })}
        menuOpen={menuOpen}
