...
Deno.serve(async (req) => {
  try {
    ...
    addText('a) O primeiro compartilhamento de lucros sera disponibilizado ao PARCEIRO em ate 60 (sessenta) dias contados da data do aporte inicial;');
    ...
    addText('8.5. Encerrada a vigencia contratual, o valor integral correspondente ao capital aportado pelo PARCEIRO sera disponibilizado para retirada em ate 60 (sessenta) dias, contados da data formal de encerramento do contrato, respeitados os ciclos operacionais e financeiros em andamento.');
    ...
    addText('13.1. O aceite eletronico deste contrato, realizado por meio de marcacao de checkbox ou clique em botao de confirmacao na plataforma, possui plena validade juridica, nos termos da Lei n. 14.063/2020 e da Medida Provisoria n. 2.200-2/2001.');
